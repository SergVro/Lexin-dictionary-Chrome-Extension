import BackgroundWorkerTests = require("tests/unit/BackgroundWorkerTests"); BackgroundWorkerTests;
import HistoryModelTests = require("tests/unit/HistoryModelTests"); HistoryModelTests;
import LanguageManagerTests = require("tests/unit/LanguageManagerTests"); LanguageManagerTests;
import LexinDictionaryTests = require("tests/unit/LexinDictionaryTests"); LexinDictionaryTests;
