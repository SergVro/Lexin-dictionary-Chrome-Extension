...
(function () {
    function showHistory() {
        ...
        chrome.runtime.sendMessage({ method: "getHistory", langDirection: langDirection }, function (history) {
    ...
    $(function() {
        ...
        $('#clearHistory').click(function(e) {
            ...
            if (confirm('Are you sure you want to clear history for language ' + langName)) {
                chrome.runtime.sendMessage({ method: "clearHistory", langDirection: langDirection }, function() {
                    showHistory();
                });
            }
        });
